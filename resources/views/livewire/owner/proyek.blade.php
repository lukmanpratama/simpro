                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                                            ...
                                            <div class="modal-content text-bg-dark">
                                                ...
                                                <div class="modal-header">
                                                    <h5 class="modal-title">
                                                        {{$proyekId ? 'Edit Post' : 'Create Post' }}
                                                    </h5>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-3">
                                    <select wire:model.live="limit" class="form-control" aria-label="Default select example">
                                    ...
                                    @foreach ($proyeks as $proyek)
                                        <tr scope="row" wire:key="{{ $proyek->id }}">
                                            ...
                                            <td>
                                                ...
                                                <span onclick="return confirm('Are you sure you want to delete this item?') || event.stopImmediatePropagation()" wire:click="delete({{ $post->id }})" class="cursor-pointer">
